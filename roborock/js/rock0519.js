$(function () {
  ...
  $(document).on('click', '.all-box .alert', function (e) {
    ...
    Swal.fire({
      ...
      position: 'center',
      // returnFocus: false,
      confirmButtonText: '<a href="https://www.tk3c.com/member/official_card_member_add.aspx?ec=rock202206" target="_blank">立即綁卡</a>',
      confirmButtonColor: '#e0a74a'
    })
  });

  $('.bg01').last().after("<a class='store' href='https://events.tk3c.com/events_net/roborock_event/index.html?ec=rock202206' target='_blank'><img src='https://events.cdn-tkec.tw/events_net/events_net/rock202206/images/20230519/rock_go.png'></a>");
  scrollUp($('.item'));
});